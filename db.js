...
// Hostinger Business Web Hosting MySQL Connection Pool (User Specified Credentials)
const pool = mysql.createPool({
  host: process.env.DB_HOST || 'localhost',
  user: process.env.DB_USER || 'u239297722_lifeline2026',
  password: process.env.DB_PASSWORD || 'LifeLine@2026',
  database: process.env.DB_NAME || 'u239297722_lifeline2026',
...
export async function initDatabase() {
  try {
    ...
    console.log('⚡ Connected to Hostinger MySQL Database (u239297722_lifeline2026) successfully!');
